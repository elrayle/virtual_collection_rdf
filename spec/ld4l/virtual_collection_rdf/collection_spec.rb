...
describe 'LD4L::VirtualCollectionRDF::Collection' do

  subject { LD4L::VirtualCollectionRDF::Collection.new }  # new virtual collection without a subject
  ...
  describe '#rdf_subject' do
    ...
    it "should append to base URI when setting to non-URI subject" do
      ...
      expect(subject.rdf_subject).to eq RDF::URI("#{LD4L::VirtualCollectionRDF::Collection.base_uri}#{LD4L::VirtualCollectionRDF::Collection.id_prefix}123")
    end
  ...
  describe "#create" do
    it "should create a LD4L::VirtualCollectionRDF::Collection instance" do
      vc = LD4L::VirtualCollectionRDF::Collection.create(title:       "Test Title",
                                                 description: "Test description of virtual collection.",
                                                 owner:       LD4L::VirtualCollectionRDF::Person.new("http://vivo.cornell.edu/individual/JohnSmith"))
      expect(vc).to be_a(LD4L::VirtualCollectionRDF::Collection)
    end
    ...
    it "should create a virtual collection with passed in properties excluding an id" do
      vc = LD4L::VirtualCollectionRDF::Collection.create(title:       "Test Title",
                                                 description: "Test description of virtual collection.",
                                                 owner:       LD4L::VirtualCollectionRDF::Person.new("http://vivo.cornell.edu/individual/JohnSmith"))
      expect(vc.rdf_subject.to_s).to start_with "#{LD4L::VirtualCollectionRDF::Collection.base_uri}#{LD4L::VirtualCollectionRDF::Collection.id_prefix}"
    ...
    it "should create a virtual collection with partial id" do
      vc = LD4L::VirtualCollectionRDF::Collection.create(id:          "123",
                                                 title:       "Test Title",
                                                 description: "Test description of virtual collection.",
                                                 owner:       LD4L::VirtualCollectionRDF::Person.new("http://vivo.cornell.edu/individual/JohnSmith"))
      expect(vc.rdf_subject.to_s).to eq "#{LD4L::VirtualCollectionRDF::Collection.base_uri}#{LD4L::VirtualCollectionRDF::Collection.id_prefix}123"
      expect(vc.title).to eq ["Test Title"]
      expect(vc.description).to eq ["Test description of virtual collection."]
      expect(vc.owner.first.rdf_subject).to eq RDF::URI("http://vivo.cornell.edu/individual/JohnSmith")
    end
    ...
    it "should create a virtual collection with string uri id" do
      vc = LD4L::VirtualCollectionRDF::Collection.create(id:          "http://example.org/individual/vc123",
                                                 title:       "Test Title",
                                                 description: "Test description of virtual collection.",
                                                 owner:       LD4L::VirtualCollectionRDF::Person.new("http://vivo.cornell.edu/individual/JohnSmith"))
    ...
    it "should create a virtual collection with URI id" do
      vc = LD4L::VirtualCollectionRDF::Collection.create(id:          RDF::URI("http://example.org/individual/vc123"),
                                                 title:       "Test Title",
                                                 description: "Test description of virtual collection.",
                                                 owner:       LD4L::VirtualCollectionRDF::Person.new("http://vivo.cornell.edu/individual/JohnSmith"))
      expect(vc.rdf_subject.to_s).to eq "http://example.org/individual/vc123"
  ...
  describe "#add_item_with_content" do
    it "should return a LD4L::VirtualCollectionRDF::Item instance" do
  ...
  describe "#add_items_with_content" do
    ...
    it "should return an array of LD4L::VirtualCollectionRDF::Item instances" do
      vci_array = subject.add_items_with_content([RDF::URI("http://example.org/individual/b1"),
                                                  RDF::URI("http://example.org/individual/b2"),
                                                  RDF::URI("http://example.org/individual/b3")])
  ...
  describe "#get_items_content" do
    ...
    context "when start and limit are not specified" do
      ...
      it "should not return any content not aggregated by subject" do
        vc = LD4L::VirtualCollectionRDF::Collection.new('999')
  ...
  describe "#persist!" do
    context "when the repository is set" do
      context "and the item is not a blank node" do
        ...
        subject {LD4L::VirtualCollectionRDF::Collection.new("123")}
  ...
  describe '#destroy!' do
    ...
    context 'with a parent' do
      ...
      let(:parent) do
        LD4L::VirtualCollectionRDF::Collection.new('123')
      end
  ...
  describe 'attributes' do
    ...
    let(:owner) { LD4L::VirtualCollectionRDF::Person.new('456') }
  ...
  describe 'child nodes' do
    it 'should return an object of the correct class when the value is built from the base URI' do
      subject.owner = LD4L::VirtualCollectionRDF::Person.new('456')
      expect(subject.owner.first).to be_kind_of LD4L::VirtualCollectionRDF::Person
    end

    it 'should return an object with the correct URI created with a URI' do
      subject.owner = LD4L::VirtualCollectionRDF::Person.new("http://vivo.cornell.edu/individual/JohnSmith")
    ...
    it 'should return an object of the correct class when the value is a bnode' do
      subject.owner = LD4L::VirtualCollectionRDF::Person.new
      expect(subject.owner.first).to be_kind_of LD4L::VirtualCollectionRDF::Person
    end
  end
  ...
  describe '#type' do
    it 'should return the type configured on the parent class' do
      expect(subject.type).to eq [LD4L::VirtualCollectionRDF::Collection.type]
    end
  ...
  describe 'big complex graphs' do
    before do
      ...
      LD4L::VirtualCollectionRDF::Collection.property :item, :predicate => RDF::DC.relation, :class_name => DummyDocument
    end
